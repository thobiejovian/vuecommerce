                     ...
                     <div class="a-row a-spacing-small">
                      ...
                      <div class="a-row a-spacing-small">
                         ...
                         <span class="a-size-small a-color-secondary">
                           <a class="a-link-normal a-text-normal" href="#">{{product.category.type}}</a>
                         </span>
                       </div>
                       ...
                       <span class="a-size-small a-color-secondary">
                         Other Formats:
                         <span class="a-letter-space"></span>
                         <a href="#" class="a-size-small a-link-normal a-text-normal">{{product.condition.type}}</a>
                       </span>
