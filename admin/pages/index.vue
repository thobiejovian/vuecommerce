      ...
      <div class="container browsing-history">
        <div class="row">
          <div class="col-sm-8 col-8">
            ...
            <nuxt-link to="/protype" class="a-button-history margin-right-10">Add a new Condition Type</nuxt-link>
            <!-- Listing Page -->
          ...
          <div v-for="(product, index) in products" :key="product._id" class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-6 br bb">
            <div class="history-box">
              ...
              <a href="#" class="a-link-normal">
                <img :src="product.photo" alt="" class="img-fluid" style="width: 200px; height:170px;">
              </a>
...
export default {
  ...
  // asnycData is fetching Data before nuxt page finished loading on the browser.
  // it is good for SEO because dthe data will be loaded first
